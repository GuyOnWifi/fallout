...
GESTURE_HINTS = {
    "idle":     "arm relaxed at your side, don't move.",
    "jab":      "sharp straight punch forward, snap back.",
    "hook":     "horizontal hooking punch, elbow ~90°, arc across.",
    "uppercut": "upward punch from hip level, drive up.",
    "block":    "both forearms up in front of face, palms in, hold still ~1 s.",
    "overhand": "downward chopping punch, arm arcs over the top.",
    "dodge":    "lean torso sideways (band travels with your body).",
    "parry":    "sharp wrist twist, forearm rotates, no translation.",
}
...
def main():
    ...
    out_dir = prompt("Output directory", "data")
