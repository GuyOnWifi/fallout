...
inline uint8_t begin_full_range() {
  ...
  // ESP32-C3 does not enable internal pull-ups on Wire.begin, and if the
  // breakout's external pull-ups are weak or missing the bus stays floating
  // and no device answers. See arduino-esp32 issue #6376. Force them on.
